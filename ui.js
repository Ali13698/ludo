window.UI = {
  renderProfiles: function(){
    ...
    for (let i = 0; i < S.active.length; i++){
      ...
      else if (S.botInfo[p] && S.botInfo[p].avatar) av.textContent = S.botInfo[p].avatar;
      ...
      else if (S.botInfo[p]) nm.textContent = S.botInfo[p].name;
      else if (S.isOnline) nm.textContent = 'حریف';
