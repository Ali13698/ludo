...
function setupOnlineEvents(){
  Online.on('match_found',function(d){
    S.isOnline=true;S.myIdx=d.playerIndex||0;S.roomCode=d.code;S.opponent=d.opponent;
    if(typeof Game!=='undefined') Game.newGame();
    show('game');
    setTimeout(function(){if(typeof Board!=='undefined'&&Board.resize) Board.resize();},100);
  });
